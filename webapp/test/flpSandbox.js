		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Orders",
									"targetURL": "#nvidxxzsalesordxx-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nvidxxzsalesordxx-display": {
								"semanticObject": "nvidxxzsalesordxx",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nvid.xx.zsalesordxx",
									"url": sap.ui.require.toUrl("nvid/xx/zsalesordxx")
								}
							}
						}
					}
