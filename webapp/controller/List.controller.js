sap.ui.define([
    ...
    return BaseController.extend("nvid.xx.zsalesordxx.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("SoId", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "nvid.xx.zsalesordxx.view.ViewSettingsDialog",
                    controller: this
